...
(custom-theme-set-faces
 ...
 '(org-level-1 ((((class color) (min-colors 89)) (:inherit 'outline-1 :height 1.2 :foreground "#e0c341"))))
 '(org-level-2 ((((class color) (min-colors 89)) (:inherit 'outline-4 :height 1.2 :foreground "#7db1b1"))))
 '(org-level-3 ((((class color) (min-colors 89)) (:inherit 'outline-3 :height 1.2 :foreground "#bf263c"))))
 '(org-level-4 ((((class color) (min-colors 89)) (:inherit 'outline-2 :height 1.2 :foreground "#6a50a7"))))
 '(org-level-5 ((((class color) (min-colors 89)) (:inherit 'outline-5 :height 1.2))))
 '(org-level-6 ((((class color) (min-colors 89)) (:inherit 'outline-6 :height 1.2))))
 '(org-level-7 ((((class color) (min-colors 89)) (:inherit 'outline-7 :height 1.2))))
 '(org-level-8 ((((class color) (min-colors 89)) (:inherit 'outline-8 :height 1.2))))
 '(org-default ((((class color) (min-colors 89)) (:inherit default :foreground "#bebebe" :font "Input Sans Narrow" :height 1.1))))
 '(org-superstar-header-bullet ((((class color) (min-colors 89)) (:height 1.0 :raise 0.5) (raise 0.5) (:raise 0.5))))
 ...
 '(lsp-flycheck-info-unnecessary ((((class color) (min-colors 89)) (:foreground "#70c0b1"))))
